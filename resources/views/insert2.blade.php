        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @if ( Session::has('fin_success'.$i) )
                        <div class="alert alert-success alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            <span class="sr-only">Close</span>
                        </button>
                        <strong>{{ Session::get('fin_success'.$i) }}</strong>
                    </div>
                    {{Session::forget('fin_success'.$i)}}
                    @endif

                    @if ( Session::has('prod_success'.$i) )
                        <div class="alert alert-success alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            <span class="sr-only">Close</span>
                        </button>
                        <strong>{{ Session::get('prod_success.$i') }}</strong>
                    </div>
                    {{Session::forget('prod_success'.$i)}}
                    @endif
                    
                    @if ( Session::has('fin_error'.$i) )
                    <div class="alert alert-danger alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            <span class="sr-only">Close</span>
                        </button>
                        <strong>{{ Session::get('fin_error'.$i) }}</strong>
                    {{Session::forget('fin_error'.$i)}} 
                    </div>
                    @endif
                    @if ( Session::has('prod_error'.$i) )
                    <div class="alert alert-danger alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            <span class="sr-only">Close</span>
                        </button>
                        <strong>{{ Session::get('prod_error'.$i) }}</strong>
                    {{Session::forget('prod_error'.$i)}} 
                    </div>
                    @endif
